...
</code></pre><p>See the <a href="https://sharpscript.net/docs/sharp-apps#registering-servicestack-plugins" target="_blank" rel="noopener noreferrer">plugins app.settings</a> for examples of how to load and configure <a href="/plugins">ServiceStack Plugins</a>.</p>__VP_STATIC_END__`,61);function i(l,u,d,h,g,k){const n=t("WebTroubleMd");return p(),s("div",null,[c,a(n)])}var b=e(r,[["render",i]]);export{f as __pageData,b as default};
