...
</code></pre></div><p>See the <a href="https://sharpscript.net/docs/sharp-apps#registering-servicestack-plugins" target="_blank" rel="noopener noreferrer">plugins app.settings</a> for examples of how to load and configure <a href="/plugins">ServiceStack Plugins</a>.</p>__VP_STATIC_END__`,13),H=`{"title":"ServiceStack's .NET Core Utility Belt","description":"","frontmatter":{"slug":"dotnet-tool","title":"ServiceStack's .NET Core Utility Belt"},"headers":[{"level":2,"title":"Install","slug":"install"},{"level":3,"title":"Apple M1","slug":"apple-m1"},{"level":3,"title":"Update","slug":"update"},{"level":2,"title":"Usage","slug":"usage"},{"level":3,"title":"Add/Update ServiceStack References","slug":"add-update-servicestack-references"},{"level":3,"title":"Integrate with Visual Studio","slug":"integrate-with-visual-studio"},{"level":3,"title":"Integrate with Rider","slug":"integrate-with-rider"},{"level":3,"title":"Create new Project Templates","slug":"create-new-project-templates"},{"level":3,"title":"Mix Features into existing ASP.NET Core Apps","slug":"mix-features-into-existing-asp-net-core-apps"},{"level":3,"title":"Lisp REPL","slug":"lisp-repl"},{"level":3,"title":"Annotated REPL Walk through","slug":"annotated-repl-walk-through"}],"relativePath":"dotnet-tool.md","lastUpdated":1645506504352}`,D={};function U(B){return(F,W)=>(t(),a("div",null,[i,l,c,d,u,h,g,k,w,m,f,v,x,b,y,S,_,A,T,R,C,M,P,q,E,V,j,L,N,I,e("p",null,[o(p(r))])]))}const O=Object.assign(D,{setup:U});export{H as __pageData,O as default};
